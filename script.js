...
const GARDEN_NOTES = [
  ...
  "You have terrible timing but excellent intentions.",
  "The way you care is one of your best qualities.",
  "You deserve softness in return.",
  "Your laugh is genuinely contagious.",
  "You notice the small things. That's rare.",
  "You're allowed to take up space.",
  "Overthinking doesn't cancel out your clarity.",
  "Some people are better for having met you.",
  "Your stubbornness is your superpower in disguise.",
  "You don't give yourself enough credit.",
  "The little things you do matter more than you know.",
  "You're exactly where you're supposed to be.",
  "Your version of fun is unmatched.",
  ...
  "You have a very specific kind of magic.",
  "Rest is not quitting. You know this. Act like it.",
  ...
  "Your sense of humour is an actual gift.",
...
function initMusic() {
  ...
  S.audio.addEventListener('error',          () => { S.playing = false; refreshPlayerUI(); });
...
function togglePlay() {
  ...
  /* If no src yet, load first song */
  if (!S.audio.src || S.audio.src.endsWith('undefined') || S.audio.src === window.location.href) {
    playSong(0); return;
  }
  S.audio.play().then(() => { S.playing = true; refreshPlayerUI(); }).catch(() => {});
}
